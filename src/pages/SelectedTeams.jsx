...
const SelectedTeams = () => {
  ...
  const teams = {
    ...
    open: [
      { name: "IoT Green Minds", school: "Gampaha" },
      { name: "Robototec", school: "Batticaloa" },
      { name: "Team JAS", school: "Gampaha" },
      { name: "Salvis", school: "Anuradhapura" },
      { name: "wheelorbi", school: "Kalutara" },
      { name: "SypherLink", school: "Kegalle" },
      { name: "VisionX", school: "Colombo" },
      { name: "EcoShield", school: "Colombo" },
      { name: "Outlaws", school: "Kandy" },
      { name: "AURA", school: "Colombo" },
      { name: "Synop", school: "Colombo" },
      { name: "Default_Drive", school: "Colombo" },
      { name: "SyntaxSquad", school: "Kegalle" },
      { name: "Arduino Challenge Hub", school: "Hambantota" },
      { name: "SmartCare", school: "Kalutara" },
      { name: "PlasticPals", school: "Polonnaruwa" },
      { name: "TeraNode", school: "Galle" },
      { name: "TecTide", school: "Kandy" },
      { name: "VertiGrow", school: "Colombo" },
      { name: "ZEUS", school: "Kurunegala" },
      { name: "OMEGA 3.9", school: "Jaffna" },
      ...
      { name: "Econova", school: "Colombo" },
      { name: "Team Evolve", school: "Colombo" },
      { name: "Structecs", school: "Colombo" },
      { name: "Adreno", school: "Kegalle" },
      { name: "Malevolent Shrine", school: "Colombo" },
      { name: "MINDS", school: "Galle" },
